...
# Kernel dts
export RK_KERNEL_DTS=rv1106g-luckfox-pico-ultra-custom.dts
...
export RK_PARTITION_CMD_IN_ENV="32K(env),512K@32K(idblock),256K(uboot),32M(boot),512M(rootfs),512M(oem),6G(userdata)"
...
# Buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=luckfox_pico_ultra_custom_defconfig
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=luckfox_rv1106_pico_ultra_custom_uboot_defconfig

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=luckfox_rv1106_pico_ultra_custom_linux_defconfig
